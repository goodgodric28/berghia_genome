...
directory = "[PATH TO]/tissue_diffexp/deseq2_tissues/brain/"
read_dir = "[PATH TO]/tissue_diffexp/read_files/"
setwd(directory)

# Set the prefix for each output file name
outputPrefix = "Bs_tissues_brain_DESeq2"
...
dds = DESeq(ddsHTSeq)
res = results(dds, contrast=c(1,-1/6,-1/6,-1/6,-1/6,-1/6,-1/6))
...
# Subset results to only include upregulated brain genes 
...
# Subset results to only include downregulated brain genes 
...
row.names(out) = dat
colnames(out) = c("Only expressed in brain", "Upregulated in brain")
...
# Pull out genes both upregulated and exclusively expressed in the brain
