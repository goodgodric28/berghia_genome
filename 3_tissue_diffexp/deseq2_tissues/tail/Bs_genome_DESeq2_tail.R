...
directory = "[PATH TO]/tissue_diffexp/deseq2_tissues/tail/"
...
other_genes = scan("[PATH TO]/tissue_diffexp/deseq2_clades/all_others/gene_annotations/Bs_tissues_all_others_DESeq2-TA-only-genelist.txt", what="", sep="\n")
mollusca_genes = scan("[PATH TO]/tissue_diffexp/deseq2_clades/mollusca/gene_annotations/Bs_tissues_mollusca_DESeq2-TA-only-genelist.txt", what="", sep="\n")
gastropoda_genes = scan("[PATH TO]/tissue_diffexp/deseq2_clades/gastropoda/gene_annotations/Bs_tissues_gastropoda_DESeq2-TA-only-genelist.txt", what="", sep="\n")
nudibranchia_genes = scan("[PATH TO]/tissue_diffexp/deseq2_clades/nudibranchia/gene_annotations/Bs_tissues_nudibranchia_DESeq2-TA-only-genelist.txt", what="", sep="\n")
aeolidoidea_genes = scan("[PATH TO]/tissue_diffexp/deseq2_clades/aeolidoidea/gene_annotations/Bs_tissues_aeolidoidea_DESeq2-TA-only-genelist.txt", what="", sep="\n")
berghia_genes = scan("[PATH TO]/tissue_diffexp/deseq2_clades/berghia/gene_annotations/Bs_tissues_berghia_DESeq2-TA-only-genelist.txt", what="", sep="\n")
